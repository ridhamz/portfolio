    ...
    return (
        <Fragment>
            ...
            <Modal show={details} modalClosed={detailsCancelHandler}>
                <div className="text-secondary" style={{ padding: '4px' }}>Description :</div>
                {project.description}<br />
                <div className="text-secondary" style={{ padding: '4px' }}>Technologies used :</div>
                {technologiesUsed.map(tech => <div key={tech}>- {tech}</div>)}

                <div style={{ borderTop: '1px solid #eece1a', padding: '10px', marginTop: '8px' }}>
            ...
            <Modal show={video} modalClosed={videoCancelHandler}>
                <p>Preview :</p>
                {videoSrc ? <Video src={videoSrc} /> : <center><LoadingSpinner /></center>}
            ...
            <li className='project-item'>
                <Card>
                    <div>
                        <img src={process.env.REACT_APP_IMG_URL + '/' + project.image} alt="error" />
                    </div>
                    ...
                    <div className='project-item__actions'>
                        ...
                        <a className='button' href={project.githubLink}>Code</a>
                        {linkExist && <a className='button' href={project.link}>Link</a>}
                    </div>
                </Card>
            </li>
        </Fragment>
